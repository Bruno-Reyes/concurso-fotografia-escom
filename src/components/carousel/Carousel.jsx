...
export default function Carousel() {
      ...
      <div className="custom-galleria-footer mt-3">
        <div className="flex justify-content-between w-full">
          ...
          <Button
            ...
            className="fullscreen-button align-items-right"
          />
        </div>
      </div>
    );
  ...
  return (
    <div class="flex flex-row flex-wrap w-full mt-6 mx-4">
      <div class="flex flex-column w-5 h-">
        {images && (
          <Card title={images[activeIndex].author} className="shadow-8">
      ...
      <div className="card galleria-demo flex flex-column align-items-center justify-content-center w-5">
        <Galleria
          ref={galleria}
          value={images}
